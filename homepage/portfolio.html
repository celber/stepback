      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image" style="background-image: url('images/work-1.jpg'); "></a>
            <div class="text">
          ...
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image order-2" style="background-image: url('images/work-2.jpg'); "></a>
          ...
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image" style="background-image: url('images/work-3.jpg'); "></a>
            <div class="text">
          ...
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image order-2" style="background-image: url('images/work-4.jpg'); "></a>
            <div class="text order-1">
              <h4 class="subheading">Application</h4>
              <h2 class="heading"><a href="portfoli-singleo.html">Even the all-powerful Pointing has no control</a></h2>
              <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
          ...
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image" style="background-image: url('images/work-5.jpg'); "></a>
            <div class="text">
          ...
          <div class="block-3 d-md-flex ftco-animate">
            <a href="portfolio-single.html" class="image order-2" style="background-image: url('images/work-6.jpg'); "></a>
            <div class="text order-1">
